...
bool Window::Create(const WindowDesc& desc)
{
    ...
    windowClass.hCursor = static_cast<HCURSOR>(LoadCursorW(nullptr, MAKEINTRESOURCEW(32512)));
    windowClass.hIcon = static_cast<HICON>(LoadIconW(nullptr, MAKEINTRESOURCEW(32512)));
